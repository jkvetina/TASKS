...
USING (
    ...
    SELECT 3.495242224206583e+16 AS component_id, 'BUTTON' AS component_type, 'REFRESH_TASKS' AS component_name, 100 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 3.495242224206583e+16 AS component_id, 'BUTTON' AS component_type, 'REFRESH_TASKS' AS component_name, 100 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 3.5338344188008044e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_PROJECTS' AS component_name, 300 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 3.5338344188008044e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_PROJECTS' AS component_name, 300 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 3.5338344188008044e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_PROJECTS' AS component_name, 300 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 3.541632176802185e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_CLIENTS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 400 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 3.541632176802185e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_CLIENTS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 400 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.5414919622005624e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_COMMITS' AS component_name, 500 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.5414919622005624e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_COMMITS' AS component_name, 500 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.5414919622005624e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_COMMITS' AS component_name, 500 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.541519090900563e+16 AS component_id, 'PROCESS' AS component_type, '<span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SYNC_GITHUB' AS component_name, 500 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.541519090900563e+16 AS component_id, 'PROCESS' AS component_type, '<span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SYNC_GITHUB' AS component_name, 500 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.541519090900563e+16 AS component_id, 'PROCESS' AS component_type, '<span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SYNC_GITHUB' AS component_name, 500 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.551922094883603e+16 AS component_id, 'REGION' AS component_type, 'Project Boards [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 200 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.551922094883603e+16 AS component_id, 'REGION' AS component_type, 'Project Boards [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 200 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.553960161385549e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_REPOS' AS component_name, 510 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.553960161385549e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_REPOS' AS component_name, 510 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.564618380430284e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_STATUSES' AS component_name, 230 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.564618380430284e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_STATUSES' AS component_name, 230 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.564618380430284e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_STATUSES' AS component_name, 230 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.565835746730544e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_SWIMLANES' AS component_name, 250 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.565835746730544e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_SWIMLANES' AS component_name, 250 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.565835746730544e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_SWIMLANES' AS component_name, 250 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.640219020192903e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_USERS' AS component_name, 950 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.640219020192903e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_USERS' AS component_name, 950 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.666561639236382e+16 AS component_id, 'ITEM' AS component_type, 'P510_CLIENT_ID' AS component_name, 510 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.666573125036382e+16 AS component_id, 'ITEM' AS component_type, 'P510_PROJECT_ID' AS component_name, 510 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.666615026936382e+16 AS component_id, 'ITEM' AS component_type, 'P515_OWNER_ID' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.666621004436383e+16 AS component_id, 'ITEM' AS component_type, 'P515_REPO_ID' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.666639369236383e+16 AS component_id, 'BUTTON' AS component_type, 'SHOW_ENDPOINTS' AS component_name, 510 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.6705645323202856e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_USERS' AS component_name, 952 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.6705645323202856e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_USERS' AS component_name, 952 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.693506019653841e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_ENDPOINTS' AS component_name, 515 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.693506019653841e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_ENDPOINTS' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.696145457577318e+16 AS component_id, 'ITEM' AS component_type, 'P515_CLIENT_ID' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.696177364577512e+16 AS component_id, 'ITEM' AS component_type, 'P515_PROJECT_ID' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.70741733171343e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_BOARDS' AS component_name, 200 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.70741733171343e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_BOARDS' AS component_name, 200 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.707656552813433e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_ROLES' AS component_name, 955 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.707656552813433e+16 AS component_id, 'PROCESS' AS component_type, 'SAVE_ROLES' AS component_name, 955 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.738131170787251e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_CATEGORIES<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 220 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.738131170787251e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_CATEGORIES<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 220 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.773981361962691e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>MERGE_TASKS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 108 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.773981361962691e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>MERGE_TASKS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 108 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.8387700539767256e+16 AS component_id, 'ITEM' AS component_type, 'P500_CLIENT_ID' AS component_name, 500 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.838807265876884e+16 AS component_id, 'ITEM' AS component_type, 'P500_PROJECT_ID' AS component_name, 500 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.865867960169101e+16 AS component_id, 'PROCESS' AS component_type, 'REFRESH_MV' AS component_name, 963 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    SELECT 4.874355080714803e+16 AS component_id, 'BUTTON' AS component_type, 'MOVE_TASK_TO_TOP' AS component_name, 105 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874355080714803e+16 AS component_id, 'BUTTON' AS component_type, 'MOVE_TASK_TO_TOP' AS component_name, 105 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874368540514804e+16 AS component_id, 'PROCESS' AS component_type, 'UPDATE_AND_MOVE_TO_TOP' AS component_name, 105 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874368540514804e+16 AS component_id, 'PROCESS' AS component_type, 'UPDATE_AND_MOVE_TO_TOP' AS component_name, 105 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874455430314805e+16 AS component_id, 'BUTTON' AS component_type, 'SHOW_ALL_PROJECTS' AS component_name, 955 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874455430314805e+16 AS component_id, 'BUTTON' AS component_type, 'SHOW_ALL_PROJECTS' AS component_name, 955 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.874455430314805e+16 AS component_id, 'BUTTON' AS component_type, 'SHOW_ALL_PROJECTS' AS component_name, 955 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    SELECT 9.094623983886107e+16 AS component_id, 'REGION' AS component_type, 'Repositories [GRID]' AS component_name, 510 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 9.094623983886107e+16 AS component_id, 'REGION' AS component_type, 'Repositories [GRID]' AS component_name, 510 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 9.294473595686546e+16 AS component_id, 'REGION' AS component_type, 'Roles [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 960 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.0432375069790549e+17 AS component_id, 'REGION' AS component_type, 'Projects [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 300 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.0432375069790549e+17 AS component_id, 'REGION' AS component_type, 'Projects [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 300 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.0432375069790549e+17 AS component_id, 'REGION' AS component_type, 'Projects [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 300 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3787374884839949e+17 AS component_id, 'REGION' AS component_type, 'Endpoints [GRID]' AS component_name, 515 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3787374884839949e+17 AS component_id, 'REGION' AS component_type, 'Endpoints [GRID]' AS component_name, 515 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3923045261590611e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Clients [GRID]' AS component_name, 400 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3923045261590611e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Clients [GRID]' AS component_name, 400 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3923045261590611e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Clients [GRID]' AS component_name, 400 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3923045261590611e+17 AS component_id, 'REGION' AS component_type, 'Clients [GRID]' AS component_name, 400 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    SELECT 1.84662860801965e+17 AS component_id, 'REGION' AS component_type, 'Commits [GRID]' AS component_name, 500 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.84662860801965e+17 AS component_id, 'REGION' AS component_type, 'Commits [GRID]' AS component_name, 500 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.84662860801965e+17 AS component_id, 'REGION' AS component_type, 'Commits [GRID]' AS component_name, 500 AS page_id, 'PROJECT_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.8562299003282922e+17 AS component_id, 'REGION' AS component_type, 'Users [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 950 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.8562299003282922e+17 AS component_id, 'REGION' AS component_type, 'Users [GRID] <span style="color: #999;">&mdash; Interactive Report</span>' AS component_name, 950 AS page_id, 'USERS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.8754295825742262e+17 AS component_id, 'REGION' AS component_type, 'Map Components [GRID]' AS component_name, 963 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.8754295825742262e+17 AS component_id, 'REGION' AS component_type, 'Map Components [GRID]' AS component_name, 963 AS page_id, NULL AS role_id, NULL AS is_active FROM DUAL UNION ALL
    SELECT 1.981792910309894e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Categories [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 220 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.981792910309894e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Categories [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 220 AS page_id, 'BOARDS_MANAGER' AS role_id, 'Y' AS is_active FROM DUAL
) s
ON (
