...
USING (
    ...
    SELECT 4.5414919622005624e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_COMMITS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 500 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.5414919622005624e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_COMMITS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 500 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.553960161385549e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_REPOSITORIES<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 510 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.553960161385549e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_REPOSITORIES<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 510 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 4.693506019653841e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_ENDPOINTS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 515 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 4.693506019653841e+16 AS component_id, 'PROCESS' AS component_type, '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="fa fa-play-circle" style="color: #555; margin: 0.125rem 0.5rem 0 0;"></span>SAVE_ENDPOINTS<span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 515 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 9.094623983886107e+16 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Repositories [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 510 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 9.094623983886107e+16 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Repositories [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 510 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3787374884839949e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Endpoints [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 515 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.3787374884839949e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Endpoints [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 515 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    ...
    SELECT 1.84662860801965e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Commits [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 500 AS page_id, 'ADMIN' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
    SELECT 1.84662860801965e+17 AS component_id, 'REGION' AS component_type, '&nbsp; &nbsp; &nbsp; Commits [GRID] <span style="color: #999;">&mdash; Interactive Report</span><span class="fa fa-warning" style="color: orange; margin: 0.125rem 0.5rem 0;"></span>' AS component_name, 500 AS page_id, 'DEFAULT_USER' AS role_id, 'Y' AS is_active FROM DUAL UNION ALL
