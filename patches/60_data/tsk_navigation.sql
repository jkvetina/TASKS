...
USING (
    ...
    SELECT 955 AS page_id, 950 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 20 AS order# FROM DUAL UNION ALL
    ...
    SELECT 965 AS page_id, 960 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 20 AS order# FROM DUAL UNION ALL
