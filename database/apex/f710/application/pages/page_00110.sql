...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(47576668215232118)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(47576712051232119)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(45518574258836025)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45518694715836026)
,p_event_id=>wwv_flow_imp.id(45518574258836025)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_security_scheme=>wwv_flow_imp.id(47196033359190547)  -- IS_USER
,p_internal_uid=>45281519596457930
);
wwv_flow_imp_page.create_page_process(
...
,p_security_scheme=>wwv_flow_imp.id(47196033359190547)  -- IS_USER
,p_internal_uid=>45281063417457925
);
wwv_flow_imp_page.create_page_process(
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_security_scheme=>wwv_flow_imp.id(47196033359190547)  -- IS_USER
,p_internal_uid=>45281481702457929
);
